...
function TimePickerModal(_ref) {
  ...
  if (_utils.passedTheme.isV3) {
    textFont = _utils.passedTheme.fonts.labelMedium;
  } else {
    textFont = _utils.passedTheme === null || _utils.passedTheme === void 0 ? void 0 : _utils.passedTheme.fonts.medium;
  }
  ...
  return /*#__PURE__*/React.createElement(_reactNative.Modal, {
    ...
    style: [_reactNative.StyleSheet.absoluteFill, styles.modalBackground, {
      backgroundColor: (_passedTheme$colors = _utils.passedTheme.colors) === null || _passedTheme$colors === void 0 ? void 0 : _passedTheme$colors.backdrop
    }]
  })), /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    style: [styles.modalContent, {
      backgroundColor: _utils.passedTheme.dark && _utils.passedTheme.isV3 ? _utils.passedTheme.colors.elevation.level3 : _utils.passedTheme.isV3 ? _utils.passedTheme.colors.surface : _utils.passedTheme.dark ? (0, _reactNativePaper.overlay)(10, _utils.passedTheme.colors.surface) : _utils.passedTheme.colors.surface,
      borderRadius: _utils.passedTheme.isV3 ? _utils.passedTheme.roundness * 6 : _utils.passedTheme.roundness
    }]
  }, /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    style: [styles.label, {
      ...textFont,
      color: _utils.passedTheme !== null && _utils.passedTheme !== void 0 && _utils.passedTheme.isV3 ? _utils.passedTheme.colors.onSurfaceVariant : _utils.passedTheme.colors.text
    }]
