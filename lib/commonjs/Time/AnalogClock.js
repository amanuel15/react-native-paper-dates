...
function AnalogClock(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, _extends({
    ...
    style: [styles.clock, {
      backgroundColor: _utils.passedTheme.isV3 ? _utils.passedTheme.colors.surfaceVariant : _utils.passedTheme.dark ? (0, _color.default)(_utils.passedTheme.colors.surface).lighten(1.4).hex() : (0, _color.default)(_utils.passedTheme.colors.surface).darken(0.1).hex()
    }]
