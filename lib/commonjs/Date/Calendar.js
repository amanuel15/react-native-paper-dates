...
function Calendar(props) {
  ...
  const selectColor = (0, React.useMemo)(() => {
    ...
    if (_utils.passedTheme.dark) {
      return (0, _utils.darkenBy)((0, _color.default)(_utils.passedTheme.colors.primary), 0.1).hex();
    }
    return (0, _utils.lightenBy)((0, _color.default)(_utils.passedTheme.colors.primary), 0.9).hex();
  }, []);
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    renderItem: _ref => {
      ...
      return /*#__PURE__*/React.createElement(_Month.default, {
        ...
        scrollMode: scrollMode,
        primaryColor: _utils.passedTheme.colors.primary,
        selectColor: selectColor,
        roundness: _utils.passedTheme.roundness,
