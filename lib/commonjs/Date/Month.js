...
function Month(props) {
  ...
  let textFont = _utils.passedTheme !== null && _utils.passedTheme !== void 0 && _utils.passedTheme.isV3 ? _utils.passedTheme.fonts.titleSmall : _utils.passedTheme.fonts.medium;
  return /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    onPress: isHorizontal ? () => onPressYear(year) : undefined,
    icon: selectingYear ? _utils.passedTheme.isV3 ? 'menu-up' : 'chevron-up' : _utils.passedTheme.isV3 ? 'menu-down' : 'chevron-down'
  }))))), grid.map(_ref2 => {
    let {
      weekIndex,
      generatedDays
